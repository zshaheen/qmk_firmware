...
[L0] = LAYOUT_ansi_84(
     ...
     KC_NO,            KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,  KC_NO,   KC_NO,            KC_NO,  KC_NO,    KC_NO,
     KC_NO,  KC_NO, KC_NO,                               KC_NO,                                 TD(TD_MK_WH_TOGGLE),KC_NO,KC_NO,  KC_NO,  KC_NO,  KC_NO),
...
[L1] = LAYOUT_ansi_84(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 TD(TD_MK_WH_TOGGLE),MO(L2),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[L2] = LAYOUT_ansi_84(
     ...
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                TD(TD_MK_WH_TOGGLE),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
...
[L3] = LAYOUT_ansi_84(
     ...
     KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
     KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,    KC_END,
     KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 TD(TD_MK_WH_TOGGLE), MO(L4),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[L5] = LAYOUT_ansi_84(
     ...
     KC_NO,            KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     TG(L6),     KC_NO,  KC_NO,   KC_NO,            KC_NO,  KC_UP,    KC_NO,
     KC_NO,  KC_NO, KC_NO,                               KC_NO,                                 TD(TD_MK_WH_TOGGLE),KC_NO,KC_NO,  KC_LEFT,  KC_DOWN,  KC_RGHT),
[L6] = LAYOUT_ansi_84(
     KC_ESC,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   RGB_TOG,
     KC_NO,   TO(L1),     TO(L2),     TO(L3),     TO(L4),     TO(L5),     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,  KC_NO,   KC_NO, RGB_VAI,
     KC_NO,   KC_BTN1,     KC_WH_U,     KC_BTN2,     KC_NO,     KC_NO,     KC_NO,     KC_BTN1,     KC_BTN2,     KC_NO,     KC_NO,     KC_NO,  KC_NO,  KC_NO,            RGB_VAD,
     KC_NO,  KC_WH_L,     KC_WH_D,     KC_WH_R,     KC_NO,     KC_NO,     KC_NO,     KC_ACL0,     KC_ACL1,     KC_ACL2,     KC_NO,  KC_NO,            KC_NO,             KC_NO,
     KC_NO,            KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,     TG(L6),     KC_NO,  KC_NO,   KC_NO,            KC_NO,  KC_UP,    KC_NO,
     KC_NO,  KC_NO, KC_NO,                               KC_NO,                                 TD(TD_MK_WH_TOGGLE),KC_NO,KC_NO,  KC_LEFT,  KC_DOWN,  KC_RGHT)
};

void ToggleMKLayer(void) {
  if (IS_LAYER_ON(L5) || IS_LAYER_ON(L6)) {
    layer_off(L5);
    layer_off(L6);
  } else if (IS_LAYER_OFF(L5)) {
    layer_on(L5);
  }
}

void ToggleMKWHLayer(void) {
  if (IS_LAYER_ON(L5) || IS_LAYER_ON(L6)) {
    layer_off(L5);
    layer_off(L6);
  } else if (IS_LAYER_OFF(L6)) {
    layer_on(L6);
  }
}
...
void mk_wh_toggle(qk_tap_dance_state_t *state, void *user_data) {
    if (state->count >= 2) {
      ToggleMKWHLayer();
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_MK_WH_TOGGLE] = ACTION_TAP_DANCE_FN(mk_wh_toggle),
};
        ...
        switch(highest_layer) {
            ...
            case L6:
                if (i == 0 || i == 15 || i == 30 || i == 45) {
                  ...
                  else if (highest_layer == L6)
                    rgb_matrix_set_color_helper(i, HSV_YELLOW, led_min, led_max);
