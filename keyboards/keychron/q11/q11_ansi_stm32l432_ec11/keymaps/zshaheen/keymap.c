...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_91(
        ...
        TO(MAC_FN),  RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,   _______,  _______,  RGB_SPI,  RGB_SAI,  RGB_HUI,  RGB_VAI,    RGB_MOD,  RGB_TOG,            _______,
        TO(WIN_BASE),  _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,   _______,  RGB_SPD,  RGB_SAD,  RGB_HUD,  RGB_VAD,  RGB_RMOD,             _______,            _______,
